...
class IllegalCharError(Error):
    def __init__(self, pos_start, pos_end, details):
        super().__init__(
            pos_start, pos_end, "Was das? Illegaler Charakter?! ", details
        )
...
class ExpectedCharError(Error):
    def __init__(self, pos_start, pos_end, details):
        super().__init__(
            pos_start, pos_end, "Was das? Erwarteter Charakter?! ", details
        )
...
class InvalidSyntaxError(Error):
    def __init__(self, pos_start, pos_end, details=""):
        super().__init__(
            pos_start, pos_end, "Was das? Etwa ei Syntax Fehler?! Schreib ordentlich! ", details
        )
...
class RTError(Error):
    def __init__(self, pos_start, pos_end, details, context):
        super().__init__(
            pos_start, pos_end, "Was das? Ein Runtime Error?! ", details
        )
...
global_symbol_table.set("falsch", Number.false)
global_symbol_table.set("richtig", Number.true)
...
global_symbol_table.set("is_stur", BuiltInFunction.is_string)
global_symbol_table.set("is_wist", BuiltInFunction.is_list)
global_symbol_table.set("is_fun", BuiltInFunction.is_function)
global_symbol_table.set("append", BuiltInFunction.append)
global_symbol_table.set("pip", BuiltInFunction.pop)
global_symbol_table.set("extend", BuiltInFunction.extend)
global_symbol_table.set("len", BuiltInFunction.len)
global_symbol_table.set("runn", BuiltInFunction.run)
